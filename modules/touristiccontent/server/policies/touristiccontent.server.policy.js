  ...
  acl.allow([
    {
      ...
      allows: [
        {
          resources: '/api/touristiccontent',
          permissions: '*'
        },
        {
          resources: '/api/touristiccontent/import',
          permissions: '*'
        }
      ]
    },
...
exports.isAllowed = async function (req, res, next) {
  ...
  if (
    req.touristiccontent &&
    req.touristiccontent.data &&
    req.user &&
    req.touristiccontent.data.user.id === req.user.id
  ) {
    return next()
  }
